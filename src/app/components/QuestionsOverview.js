...
return (
    ...
    <div className="bg-white  text-slate-800 dark:bg-slate-900 dark:text-slate-200 min-h-screen roboto flex flex-col flex-wrap m-4 p-4 font-semibold">
      ...
      <p className="w-3/4 sm:text-sm sm:h-8 sm:p-2 text-slate-600 dark:text-slate-200 bg-slate-800 border-2 border:slate-900 dark:border-slate-200 rounded-3xl p-4">What is your age group?</p>
    ...
    {qList.optionTags === null ?
      ...
      (<ul>
        {qList.map((item,index) => (
          <>
        <li className=" w-3/4 sm:text-sm sm:h-8 sm:p-2  text-slate-600 dark:text-slate-300 bg-slate-800 border-2 border:slate-900 dark:border-slate-200 rounded-3xl p-4" 
      ...
      (<ul>
        {qList.map((item,index) => (
          <>
        <li className=" w-3/4 sm:text-sm sm:h-8 sm:p-2 text-slate-600 dark:text-slate-200 bg-slate-800 border-2 border:slate-900 dark:border-slate-200 rounded-3xl p-4" 
